...
public class Film implements Serializable {
	...
	private long id;
	@NotBlank
	@Size(min = 1, max = 250, message = "Entre 1 et 250 charactères PLEASE!!!!")
	private String titre;
	@Min(value = 1900, message = "doit etre supérieur a 1900")
	private int annee;
	@Min(value = 1, message = "doit etre supérieur a 1")
	private int duree;
	@NotBlank
	@Size(min = 20, max = 250, message = "Entre 20 et 250 charactères PLEASE!!!!")
